...
<html>
	...
	<body class="no-skin">
		...
		<br/><a href="http://www.ruzishici.top/logout">退出</a>
		...
		<script type="text/javascript">
			jQuery(function ($) {
				$("#_btnExit").click(function(){
					window.location.href="http://www.ruzishici.top/logout";
	            });
			
				$.getJSON("${_path}/index/menu",function(d) {
